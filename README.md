...
Docker Compose runs the app as two containers using the versioned image tag `vinchar/retail-banking-copilot:0.1.10`:
...
The packaged chart artifact is generated at `dist/retail-banking-copilot-0.1.10.tgz`.
